      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          <div className="flex items-center justify-center">
            <div className="relative h-[450px] w-[350px] rounded-xl bg-gradient-to-b from-pink-100 to-rose-100 p-1 shadow-2xl">
              <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-white p-6">
                <div className="space-y-4">
                  ...
                  <div className="h-4 w-32 rounded-full bg-muted mx-auto"></div>
                  <div className="space-y-2">
